...
import { DetailStockAdjustType, StockAdjustType } from '@/@core/inventory-data-types'
...
interface propsData {
  detailItems: StockAdjustType
}

const DetailItemsStockAdjust: React.FC<propsData> = ({ detailItems }) => {
...
export default DetailItemsStockAdjust
