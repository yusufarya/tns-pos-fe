...
import { DetailWarehouseTransferType, WarehouseTransferType } from '@/@core/inventory-data-types'
...
const columns: GridColDef[] = [
  ...
  { field: 'qty', headerName: 'Jumlah Transfer', width: 120 },
]

interface propsData {
  detailItems: WarehouseTransferType
}

const DetailItemsWHTransfer: React.FC<propsData> = ({detailItems}) => {
...
export default DetailItemsWHTransfer
