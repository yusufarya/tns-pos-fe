...
const columns: GridColDef[] = [
  ...
  { field: 'qty_request', headerName: 'Qty', width: 120, type: 'number' },
  {
    field: 'price',
    headerName: 'Harga',
    width: 120,
          ...
          <DataGrid
            sx={{
              ...
              '& .MuiDataGrid-columnHeader': {
                ...
                backgroundColor: `${theme.palette.mode === 'dark' ? theme.palette.primary : theme.palette.grey[50]} !important`,
