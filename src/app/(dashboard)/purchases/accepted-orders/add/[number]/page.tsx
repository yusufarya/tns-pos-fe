...
import ViewAddAcceptedOrder from '@/views/purchases/accepted-orders/view-add-accepted-order'
import { ArrowBack } from '@mui/icons-material'
import { Button, Paper, Typography } from '@mui/material'
import Link from 'next/link'

const titlePage: string = 'Tambah Penerimaan Pesanan'

const AddAcceptedOrder = () => {
  return (
    <Paper>
      <PageTitle>
      ...
      <div className='m-3 mb-10'>
        <ViewAddAcceptedOrder titlePage={titlePage} />
      </div>
    </Paper>
  )
}

export default AddAcceptedOrder
