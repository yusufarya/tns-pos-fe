...
export type PurchaseOrderResponse = {
  ...
  archived: YesOrNo
  purchaseOrderDetail: PurchaseOrderDetailResponse[]
}
...
export type CreatePurchaseOrderRequest = {
  ...
  total_qty_received?: number | 0
  total_qty_over?: number | 0
  total_discount_additional?: number | 0
  total_discount?: number | 0
  total_price: number
  total_tax?: number | 0
  total_charge?: number | 0
...
export type UpdatePurchaseOrderRequest = {
  ...
  total_discount_additional?: number
...
export type DetailPurchaseOrderType = {
  product_id: number
  product_name: string
  barcode: string
  qty_request: number
...
export type PurchaseOrderType = {
  ...
  branch_name: string
  branch_id: number
  detail?: DetailPurchaseOrderType[]
  status_id: number
  status: string
}
